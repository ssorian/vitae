    ...
    <div className="mx-auto flex w-full flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          ...
          {result && <Card><CardHeader><CardTitle>Resultado finalizado</CardTitle></CardHeader><CardContent><p className="whitespace-pre-wrap text-sm">{result.observations || 'Sin observaciones.'}</p><p className="mt-2 text-xs text-zinc-500">Realizado: {result.realizedAt ? new Date(result.realizedAt).toLocaleDateString('es-MX') : '—'}</p></CardContent></Card>}
